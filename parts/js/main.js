...
(function() {
  var assert, backlog, cloud, data, draw, draw_hl_fade, draw_status, focus, links, tag, tags, vis, _ref,
  ...
  tags = {
    ...
    edges: {
      ...
      indexed: (function() {
        var index, t1, t2, v, _i, _j, _len, _len1, _ref, _ref1, _ref2;
        index = {};
    ...
    indexed: (function() {
      ...
      for (tag in ffhome_tags) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          link = _ref[_i];
          index[link.url] = index[link.url] || (function() {
            var k, link_copy, v;
            link_copy = {
              tags: []
            };
  ...
  focus = function(d) {
    ...
    draw_hl_fade();
    text = links.box.select('ul').selectAll('li').data(tags.indexed[d.tag].links, function(d, i) {
      return d.url;
    });
    text.enter().append('li').append('a').attr('href', function(d) {
      return d.url;
    }).attr('title', function(d) {
      return ("frecency: " + d.frecency + "\n") + 'tags: ' + links.indexed[d.url].tags.join(', ');
    }).text(function(d) {
